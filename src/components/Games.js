...
const Games = () => {
    ...
    const getGames = () => {
        Axios.get('retrogamingcrud-app.up.railway.app/games')
            .then((response) => {
    ...
    const updateGame = (id) => {
        ...
        //update request
        Axios.put('retrogamingcrud-app.up.railway.app/games', updatedGame)
            .then(() => {
    ...
    //DELETE
    const deleteGame = (id) =>{
        Axios.delete(`retrogamingcrud-app.up.railway.app/games/${id}`)
        .then(()=>{
