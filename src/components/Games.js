...
const Games = () => {
    ...
    const getGames = () => {
        Axios.get('https://retrogamingcrud-app.up.railway.app/games')
            .then((response) => {
    ...
    const updateGame = (id) => {
        ...
        //update request
        Axios.put('https://retrogamingcrud-app.up.railway.app/games', updatedGame)
            .then(() => {
    ...
    //DELETE
    const deleteGame = (id) =>{
        Axios.delete(`https://retrogamingcrud-app.up.railway.app/games/${id}`)
        .then(()=>{
